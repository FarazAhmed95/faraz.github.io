...
#CONVERTER_PATH = "C:\\Program Files\\ODA\\ODAFileConverter_title 21.2.0\\ODAFileConverter.exe" 
CONVERTER_PATH = "ODAFileConverter" 
#INPUT_FOLDER = "E:\\FIVERR\jasper_1977\\testdwg_laptop" 
...
OUTPUT_DWF_NAME = INPUTFILTER[:-4]
kml_file_tmp = OUTPUT_FOLDER +"\\"+ INPUTFILTER[:-4]+ '_tmp.kml'
kml_file = OUTPUT_FOLDER +"\\"+ INPUTFILTER[:-4]+ '.kml'
...
ogr_cmd +=    kml_file + ' ' + INPUTFILTER[:-4]  +'.dxf'
os.system(ogr_cmd)
